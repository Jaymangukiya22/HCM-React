...
function Input() {
  ...
  <ul className="nav nav-fill rounded-3" style={{ borderRadius: "20px" }}>
    <li className="nav-item mb-2" style={{ paddingLeft: "3px", paddingRight: "3px" }}>
      <a
  ...
  <div className="tab-content">
    <div id="home2" className="tab-pane fade show active">
      <div className="rounded-3 p-2" style={{ backgroundColor: "#d1d3ab21" }}>
    ...
    <div id="menu32" className="tab-pane fade w-100">
      <div className="w-100">
        <div className="history-div rounded-3" style={{ maxHeight: "100vh", overflowY: "scroll" }}>
          <div
          ...
          >
            <div className="input-group">
              ...
              >
                <p>
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas asperiores dolores maiores fugit
